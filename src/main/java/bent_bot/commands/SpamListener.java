...
public class SpamListener extends ListenerAdapter
{
    public void onGuildMessageReceived(GuildMessageReceivedEvent event)
    {
        ...
        //internet noob
        if (event.getMessage().getContentRaw().equalsIgnoreCase("my internet is back"))
        {
    ...
    private static String getSpam()
    {
        ...
        {
            return "动态网自由门 天安門 天安门 法輪功 李洪志 Free Tibet 六四天安門事件 The Tiananmen Square protests of 1989 天安門大屠殺 " +
        ...
        {
            return "I love China :flag_cn: Hong Kong is part of China forever :flag_cn: 相信国家 反对暴力 希望中国香港平安:flag_cn:";
        }
    }

    private static String arabicSpam()
    {
        Random random = new Random();
        ...
        //send that shit
        return String.join("", arabicArray);
    }
